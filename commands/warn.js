...
module.exports.run = async (bot, message, args) => {
    ...
    if(!message.guild.members.get(args[0]) || message.mentions.users.size < 1)  return message.reply("you must mention someone or provide an id to warn them. (Logic at its finest.)").catch(e => require("../utils/error.js").error(bot, e));
