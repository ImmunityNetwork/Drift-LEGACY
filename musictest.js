...
module.exports = function (client, options) {
	...
	function play(msg, suffix) {
		...
		if (msg.member.voiceChannel === undefined) 
            const errormusicEmbed = new Discord.RichEmbed()
            .setTitle('')
            ...
            message.channel.sendEmbed(errormusicEmbed).then(message => message.delete(60000));

		// Make sure the suffix exists.
		if (!suffix) return msg.channel.sendMessage(wrap('No video specified!'));
            const errormusicEmbed1 = new Discord.RichEmbed()
            .setTitle('')
            .setAuthor('Drift Music -', message.author.avatarURL)
            .setColor(0x00AE86)
            .addField('Error - ',  `You have not specified a video!`)
            .setFooter("Drift is protected under GPL-3.0.", "https://cdn.discordapp.com/attachments/390285194617421835/394940813865385995/FFADA4B0-4EF6-4441-BAE8-C525975E7418.png");
            message.channel.sendEmbed(errormusicEmbed1).then(message => message.delete(60000));
		...
		if (queue.length >= MAX_QUEUE_SIZE) {
            const errormusicEmbed2 = new Discord.RichEmbed()
            .setTitle('')
            .setAuthor('Drift Music -', message.author.avatarURL)
            .setColor(0x00AE86)
            .addField('Error - ',  `The queue is full at this time.`)
            .setFooter("Drift is protected under GPL-3.0.", "https://cdn.discordapp.com/attachments/390285194617421835/394940813865385995/FFADA4B0-4EF6-4441-BAE8-C525975E7418.png");
            message.channel.sendEmbed(errormusicEmbed2).then(message => message.delete(60000));
		}

		// Get the video information.
        const searchingmusicEmbed = new Discord.RichEmbed()
        .setTitle('')
	    .setAuthor('Drift Music -', message.author.avatarURL)
	    .setColor(0x00AE86)
	    .addField('Error - ',  `You have requested an invalid video!`)
	    .setFooter("Drift is protected under GPL-3.0.", "https://cdn.discordapp.com/attachments/390285194617421835/394940813865385995/FFADA4B0-4EF6-4441-BAE8-C525975E7418.png");
		msg.channel.sendEmbed().then(response => {
			...
			YoutubeDL.getInfo(searchstring, ['-q', '--no-warnings', '--force-ipv4'], (err, info) => {
				...
				if (err || info.format_id === undefined || info.format_id.startsWith('0')) {
            		const errormusicEmbed3 = new Discord.RichEmbed()
            		.setTitle('')
	            	.setAuthor('Drift Music -', message.author.avatarURL)
	            	.setColor(0x00AE86)
	            	.addField('Error - ',  `You have requested an invalid video!`)
	            	.setFooter("Drift is protected under GPL-3.0.", "https://cdn.discordapp.com/attachments/390285194617421835/394940813865385995/FFADA4B0-4EF6-4441-BAE8-C525975E7418.png");
	            	message.channel.sendEmbed(errormusicEmbed3).then(message => message.delete(60000));
				}
